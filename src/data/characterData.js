...
export const consumptionCharacters = {
  tiger: {
    ...
    name: '호균이',
    type: '균형형',
    description: '모든 소비, 딱 알맞게 쓰는 균형소비 호균이 🐯',
    pattern: {
      식비: 49,
      교통비: 17,
      통신비: 17,
  ...
  horse: {
    ...
    name: '대중교통 말스터',
    type: '교통 위주형',
    description: '지하철과 버스 없인 못 살아, 교통비 말스터 🐴',
    pattern: {
      식비: 62,
      교통비: 38,
      통신비: 0,
  ...
  panda: {
    ...
    name: '푸드판다',
    type: '식비 위주형',
    description: '하루 세끼는 기본, 간식도 챙기는 푸드판다 🐼',
    pattern: {
      식비: 78,
      교통비: 0,
      통신비: 22,
  ...
  cat: {
    ...
    name: '집콕냥이',
    type: '절약형',
    description: '밖에 안 나가도 행복한 여가제로 집콕냥이 🐱',
    pattern: {
      식비: 59,
      교통비: 20,
      통신비: 21,
